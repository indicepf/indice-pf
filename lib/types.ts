...
export type Profile = { id: string; nome: string | null; telefone: string | null; regiao: string | null; is_admin: boolean | null; sexo: string | null; data_nascimento: string | null }
