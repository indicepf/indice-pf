    ...
    <main className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="grid sm:grid-cols-2 gap-5 mt-8 items-start">
        ...
        <Card className="p-6 border-accent/40 shadow-[var(--shadow-brand)] relative">
          ...
          <button disabled className="mt-6 inline-flex items-center justify-center w-full rounded-[var(--r-sm)] px-4 py-2 text-sm font-medium bg-accent text-white opacity-60 cursor-not-allowed">
            Assinatura em breve
          </button>
          <p className="text-xs text-faint mt-3">A assinatura será aberta quando o checkout estiver no ar.</p>
        </Card>
      </div>
    </main>
  )
